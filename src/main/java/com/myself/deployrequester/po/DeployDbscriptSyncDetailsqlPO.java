...
public class DeployDbscriptSyncDetailsqlPO {
    private String deploydbscriptsyncdetailsqlid = UUID.randomUUID().toString();
    ...
    public String getDeploydbscriptsyncdetailsqlid() {
        return deploydbscriptsyncdetailsqlid;
    }

    public void setDeploydbscriptsyncdetailsqlid(String deploydbscriptsyncdetailsqlid) {
        this.deploydbscriptsyncdetailsqlid = deploydbscriptsyncdetailsqlid == null ? null : deploydbscriptsyncdetailsqlid.trim();
    }
