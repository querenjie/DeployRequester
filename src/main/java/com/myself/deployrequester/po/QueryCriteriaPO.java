...
public class QueryCriteriaPO {
    ...
    private String testflagmodifytime;      //修改测试环境是否通过的标志的时间。用系统当前时间。
    ...
    public String getTestflagmodifytime() {
        return testflagmodifytime;
    }

    public void setTestflagmodifytime(String testflagmodifytime) {
    ...
    public String toString() {
        return "QueryCriteriaPO{" +
                ...
                ", testflagmodifytime='" + testflagmodifytime + '\'' +
