...
public class LoggerUtil {
	 ...
	 *            异常对象
	 */
	public static void info(Log logger, Object obj, Throwable e) {
		if (logger.isInfoEnabled()) {
	 ...
	 *            对象
	 */
	public static void infoNoPrefix(Log logger, Object obj) {
		if (logger.isInfoEnabled()) {
			logger.info(obj);
		}
	}
	 ...
	 *            对象
	 */
	public static void warn(Log logger, Object obj) {
	 ...
	 *            异常
	 */
	public static void warn(Log logger, Object obj, Throwable t) {
	 ...
	 *            可为空
	 */
	public static void error(Log logger, Object obj, Throwable t) {
	 ...
	 * 
	 */
	public static void digesterInfo(Log logger, String... infos) {
		try {
			// 打印摘要日志
